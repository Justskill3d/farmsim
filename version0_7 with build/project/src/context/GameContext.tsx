...
const gameReducer = (state: GameState, action: GameAction): GameState => {
  switch (action.type) {
    ...
    case 'ADD_EXPERIENCE': {
      ...
      // Only trigger level up if we've actually gained a level
      if (newLevel > currentLevel) {
        ...
        return {
          ...
          showPerkSelection: true, // Add this line to show perk selection
          notification: {
            title: 'Level Up!',
    ...
    case 'SELECT_PERK': {
      ...
      return {
        ...
        currentSkillLevelUp: null,
        showPerkSelection: false // Add this line to hide perk selection after choosing
      };
    }
