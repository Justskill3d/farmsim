...
export type ItemType = 'tool' | 'seed' | 'crop' | 'fish' | 'mineral' | 'foraged' | 'resource' | 'meal' | 'treasure' | 'equipment' | 'relic' | 'component' | 'consumable';
...
export type CraftingCategory = 'consumable' | 'equipment' | 'relic';
...
export type GameAction =
  ...
  | { type: 'PLANT_SEED'; payload: { plotId: number; seedId: string; daysToMature: number } }
